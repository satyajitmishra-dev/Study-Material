                ...
                {MOCK_PROJECTS.map((project) => (
                  <Card key={project.id} className="flex flex-col justify-between h-[180px] group">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
                      ...
                      <Link href={`/projects/${(project as any).slug || project.id}`} className="text-[11px] text-stone hover:text-warm-white flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/admin/import" className="block group">
                <div className="flex flex-col justify-between h-[120px] p-4 rounded-xl bg-charcoal/20 border border-white/5 hover:bg-charcoal/40 hover:border-white/10 transition-all duration-150">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-stone leading-relaxed">Import repositories with dynamic metadata scraping</p>
                  </div>
              ...
              <Link href="/admin/seo" className="block group">
                <div className="flex flex-col justify-between h-[120px] p-4 rounded-xl bg-charcoal/20 border border-white/5 hover:bg-charcoal/40 hover:border-white/10 transition-all duration-150">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-stone leading-relaxed">Real-time meta validation and search engine previews</p>
                  </div>
                  <div className="flex justify-end pt-2 mt-auto">
                    <ArrowUpRight className="w-4 h-4 text-stone group-hover:text-warm-white transition-colors" />
                  </div>
              ...
              <Link href="/admin/analytics" className="block group">
                <div className="flex flex-col justify-between h-[120px] p-4 rounded-xl bg-charcoal/20 border border-white/5 hover:bg-charcoal/40 hover:border-white/10 transition-all duration-150">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-stone leading-relaxed">Deep visual insights and course completion graphs</p>
                  </div>
                  <div className="flex justify-end pt-2 mt-auto">
                    <ArrowUpRight className="w-4 h-4 text-stone group-hover:text-warm-white transition-colors" />
                  </div>
