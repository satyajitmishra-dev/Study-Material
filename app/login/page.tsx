        ...
        <div className="space-y-8 relative z-10 my-auto">
          ...
          <div className="space-y-5 text-[13px] font-light text-stone leading-relaxed">
            ...
            <div className="flex gap-3">
              ...
              <p>**Verified Portfolio Badges**: Showcase AWS, Google, and LeetCode certifications directly to verified recruiters.</p>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                {verificationRequired && (
                  <button
                    ...
                    className="block mt-1.5 text-accent-cyan hover:underline font-bold text-[11px]"
                  >
