...
export default async function AuthorProfilePage({ params }: PageProps) {
  ...
  const personSchema = SchemaMarkup.person({
    name: authorName,
    bio: authorBio,
    url: `${baseUrl}/authors/${username}`,
    image: authorAvatar,
  ...
  const breadcrumbSchema = SchemaMarkup.breadcrumb([
    ...
    { name: 'Authors', url: `${baseUrl}/posts` },
    { name: `@${username}`, url: `${baseUrl}/authors/${username}` }
  ]);
